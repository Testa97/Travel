...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', '9eCGdeGGFHQ2MCOROJRJMf4LSHE72Duu-NG22ttQTCM')
...
ALLOWED_HOSTS = ["web-production-3ed2.up.railway.app", "127.0.0.1", "localhost"]
...
DATABASES['default'].update(dict(db_from_env))
